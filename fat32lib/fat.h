 ...
 * <returns>One of the return codes defined in fat.h.</returns>
 * <remarks>
 * If the operation is initialized successfully this function will return FAT_OP_IN_PROGRESS, however the operation
 ...
 * response argument to FAT_STREAMING_RESPONSE_READY. As long as you do this everytime
 ...
 * the callback function is called you can set the response pointer to FAT_STREAMING_RESPONSE_SKIP.
 ...
 * the data and set the response pointer to FAT_STREAMING_RESPONSE_READY or end the
 * transfer by setting the response pointer to FAT_STREAMING_RESPONSE_STOP. Once you
 * set the response pointer to FAT_STREAMING_RESPONSE_STOP the callback function will
 ...
 * pointer is set to FAT_AWAITING_DATA. Please see the examples included for more
 * details.
 * </summary>
 * <param name="handle">A pointer to a file handle FAT_FILE structure.</param>
 * <param name="buffer">A buffer containing the bytes to be written.</param>
